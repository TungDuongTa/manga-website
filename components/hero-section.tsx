...
import { Star, BookOpen, Play, ChevronLeft, ChevronRight } from 'lucide-react'
    ...
    <section className="relative h-[520px] md:h-[620px] overflow-hidden rounded-2xl z-0 bg-background">
      ...
      <div className="relative h-full flex items-center z-10">
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div key={`content-${currentIndex}`} className="max-w-lg hero-slide-left">
            <div className="flex items-center gap-2 mb-4">
              <Badge className="bg-primary text-primary-foreground">Featured</Badge>
              <Badge variant="outline" className="border-accent text-accent bg-background/50">
                {currentManga.type}
              </Badge>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 text-balance drop-shadow-lg leading-tight">
              {currentManga.title}
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-4">
              ...
              <Badge variant="secondary" className="bg-secondary/80">{currentManga.status}</Badge>
            </div>

            <p className="text-foreground/80 mb-6 line-clamp-3 leading-relaxed text-base max-w-md">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href={`/manga/${currentManga.id}/chapter/1`}>
              ...
              <Link href={`/manga/${currentManga.id}`}>
                <Button size="lg" variant="outline" className="gap-2 bg-background/50 backdrop-blur-sm hover:bg-background/80">
